...
- 可在设置中导出或导入 JSON 备份。
- 喝咖啡动作支持首页、右键菜单和自由活动，播放捧杯、抿咖啡、满足微笑的 8 帧动画；主动互动小幅增加心情和精力。
- 喝水提醒默认开启、间隔 60 分钟，可在设置中开关并调整为 1–480 分钟；备忘录提醒优先。饱食低于 30 时显示“要饿坏了，要饿坏了”，持续饥饿每分钟提示一次。
- 备忘录支持不重复、每天、工作日（周一至周五）、每周。确认后按本机日历时间安排下一次，保留提前提醒的时间差；错过多次时只补一条，确认后跳到未来。可用“停止重复”结束系列。
- 足球、篮球、举哑铃、唱歌与羽毛球一样，支持首页按钮、右键菜单和自由活动；主动互动计入玩耍任务。
- 乒乓球同样支持首页、右键和自由活动，主动互动计入玩耍任务。加班支持手动和随机触发；自由活动中出现概率平时约 7.7%，本机时间每天 18:00–24:00 提高为 29.4%。午夜恢复普通概率，关闭自由活动则不自动触发；备忘录提醒优先。
